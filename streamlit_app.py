...
maxIndex = Wishlist['Brickeconomy Value'].tolist().index(max(Wishlist['Brickeconomy Value']))
...
def main():
    ...
    with container2:
        ...
        with col4:
            st.metric(label=print("Most Expensive Wishlist Minifigure"), value=print(Wishlist['Name'][maxIndex]  + " (" + str(Wishlist['Brickeconomy Value'][maxIndex]) + ")"))
