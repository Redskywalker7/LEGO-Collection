...
Wishlist_Table = Set_Minifig_Values_Table = go.Figure(data=[go.Table(
    columnwidth = [2,2,5,1,2,1],
    header=dict(values=("<b>Bricklink ID</b>","<b>Rebrickable ID</b>","<b>Minifigure</b>","<b>Theme</b>","<b>Contained Set</b>","<b>Value</b>"),
                #fill_color=colours[0],
                align='center'),
    cells=dict(values=[LD.Wishlist_with_vals['Minifig Number'],LD.Wishlist_with_vals['Rebrickable ID'],LD.Wishlist_with_vals['Name'],LD.Wishlist_with_vals['Theme'],LD.Wishlist_with_vals['Set Number'],LD.Wishlist['Minifig Value']],
               #fill_color=colours[1],
